...
It is designed to work with Puppet 4 and 5 (Puppet Enterprise 2015.2 and later), but should be compatible with all versions of Puppet.

Tasks will only be available for PE 2017.3 and above.

## Development - Contribute to the module
